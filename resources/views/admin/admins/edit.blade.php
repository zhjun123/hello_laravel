...
@section('admin-content')
    <div class="tpl-content-wrapper">
        ...
        <ol class="am-breadcrumb">
            ...
            <li><a href="#">{{trans('admin.admins_edit')}}</a></li>
        </ol>
            ...
            <div class="tpl-block ">
                <div class="am-g tpl-amazeui-form">
                    <div class="am-u-sm-12 am-u-md-9">
                        <form class="am-form am-form-horizontal" method="POST" action="{{url('admins/admins')}}/{{$old->id}}">
                            {{ csrf_field() }}
                            {{method_field('PATCH')}}
                            ...
                            <div class="am-form-group">
                                <div class="am-u-sm-9 am-u-sm-push-3">
                                    ...
                                    <button type="button" class="am-btn am-btn-primary" onclick="self.location=document.referrer;">返回</button>
                                </div>
                            </div>
                        </form>
                    </div>
